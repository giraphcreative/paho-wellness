KJE.sEmailFooter = "\n\n-------------------------------------------------------------\nPAHOWHO Federal Credit Union https://www.bienestaradvisors.org\n-------------------------------------------------------------\n"
//
...
//KJE.ReportHeader="<div class='KJEReportTitleBlock'><div class='KJEReportTitle'>**REPORT_TITLE**</div><br><div class=KJELogo><img src='**LOGO**' class=KJELogo alt='PAHOWHO Federal Credit Union'></div>**V3HEADERDATA**</div>";
//KJE.ReportFooter="<div class=KJECenter><p><span class='KJEBold'>**V3FOOTERDATA**</span></p><p class='KJEReportFooter KJECenter'>Information and interactive calculators are made available to you only as self-help tools for your independent use and are not intended to provide investment or tax advice. We cannot and do not guarantee their applicability or accuracy in regards to your individual circumstances. All examples are hypothetical and are for illustrative purposes. We encourage you to seek personalized advice from qualified professionals regarding all personal finance issues.</p></div><!--EXTRA_FOOTER-->";
